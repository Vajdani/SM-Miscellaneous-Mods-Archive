...
local skins = {
	...
	barrel = {
		renderables[2],
		"$CONTENT_a1e5756a-83a1-4c2f-8667-21874cb9b490/Skins/Barrel/Barrel_frier/blue/char_spudgun_barrel_frier.rend",
		"$CONTENT_a1e5756a-83a1-4c2f-8667-21874cb9b490/Skins/Barrel/Barrel_frier/green/char_spudgun_barrel_frier.rend"
	}
}
...
function PotatoShotgun:sv_save()
	self.storage:save( self.data )
end

function PotatoShotgun:cl_setRenderableTable()
...
function PotatoShotgun:cl_assembleGun()
...
function PotatoShotgun:cl_base( button )
...
function PotatoShotgun:cl_stock( button )
...
function PotatoShotgun:cl_tank( button )
...
function PotatoShotgun:cl_sight( button )
...
function PotatoShotgun:cl_barrel( button )
