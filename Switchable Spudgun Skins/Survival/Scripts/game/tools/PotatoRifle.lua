...
local skins = {
	...
	barrel = {
		renderables[2],
		"$CONTENT_a1e5756a-83a1-4c2f-8667-21874cb9b490/Skins/Barrel/Barrel_basic/blue/char_spudgun_barrel_basic.rend",
		"$CONTENT_a1e5756a-83a1-4c2f-8667-21874cb9b490/Skins/Barrel/Barrel_basic/green/char_spudgun_barrel_basic.rend"
	}
}
...
function PotatoRifle:sv_save()
	self.storage:save( self.data )
end

function PotatoRifle:cl_setRenderableTable()
...
function PotatoRifle:cl_assembleGun()
...
function PotatoRifle:cl_base( button )
...
function PotatoRifle:cl_stock( button )
...
function PotatoRifle:cl_tank( button )
...
function PotatoRifle:cl_sight( button )
...
function PotatoRifle:cl_barrel( button )
...
function PotatoRifle.loadAnimations( self )
	...
	self.tpAnimations = createTpAnimations(
		self.tool,
		{
			...
			,inspect = { "spudgun_inspect", { nextAnimation = "idle" } }
		}
	)
