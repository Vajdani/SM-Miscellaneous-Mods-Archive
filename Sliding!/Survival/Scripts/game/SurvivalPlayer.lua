...
function SurvivalPlayer.client_onCreate( self )
	...
	self.canSlide = true
	self.SlideStaminaCost = 0.7 / 40
end

function SurvivalPlayer:client_onFixedUpdate( dt )
...
function SurvivalPlayer:sv_applySlideForce( args )
    sm.physics.applyImpulse( args.plych, args.force )
end

function SurvivalPlayer:sv_adjustMoveSpeed( args )
