...
DriverSeat.Levels = {
	...
	["b98e370a-ea92-451e-a44f-be61d37b009d"] = { maxConnections = 255, allowAdjustingJoints = true, title = "cool seat" },
}
...
DriverSaddle.Levels = {
	...
	["437e291c-c53a-4aa3-bca2-b8681bb0449a"] = { maxConnections = 255, allowAdjustingJoints = true, title = "cool saddle" },
}