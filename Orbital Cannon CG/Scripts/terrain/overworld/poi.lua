...
function initPoiTiles()
	...
	-- addPoiTileLegacy( POI_CRASHSITE_AREA, 3, "$CONTENT_DATA/Terrain/Tiles/SurvivalStartArea_BigRuin_01_OrbitalCannon.tile" )
	addPoiTileLegacy( POI_CRASHSITE_AREA, 3, "$CONTENT_DATA/Terrain/Tiles/example.tile" )
