...
local size = 128
Overworld.cellMinX = -size
Overworld.cellMaxX = size - 1
Overworld.cellMinY = -size
Overworld.cellMaxY = size - 1
...
function Overworld.server_onCellCreated( self, x, y )
	...
	self:sv_spawnCannons(sm.cell.getNodesByTag(x, y, "CANNON"))
end


function Overworld:sv_spawnCannons(cannons)
	if #cannons == 0 then return end
